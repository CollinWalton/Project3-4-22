...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception{
		...
		//Invoice Scene
		FXMLLoader invoiceLoader = new FXMLLoader((getClass().getResource("InvoiceScene.fxml")));
		Parent invoicePane = invoiceLoader.load();
		Scene invoiceScene = new Scene(invoicePane, 666, 455);
		...
		//injecting invoice scene into office manager
		officeManagerController.setInvoiceScene(invoiceScene);
		...
		InvoiceSceneController invoiceController = (InvoiceSceneController) invoiceLoader.getController();
		invoiceController.setOfficeManagerScene(officeManagerScene);
